namespace MvcCore.Ext.Controllers.DataGrids.AgGrids.ColumnsManagers {
	...
	export class FilterOperatorsCfg {
		...
		public static SERVER_TYPES_EXTENDED_FILTER_MENUS = new Map<Enums.ServerType, typeof ColumnsManagers.FilterMenu>([
			[Enums.ServerType.STRING, 		ColumnsManagers.FilterMenu],
			[Enums.ServerType.BOOL, 		ColumnsManagers.FilterMenu],
			[Enums.ServerType.INT, 			ColumnsManagers.FilterMenus.Int],
			[Enums.ServerType.FLOAT, 		ColumnsManagers.FilterMenus.Float],
			[Enums.ServerType.MONEY, 		ColumnsManagers.FilterMenus.Money],
			[Enums.ServerType.DATE,			ColumnsManagers.FilterMenus.Date],
			[Enums.ServerType.DATE_TIME,	ColumnsManagers.FilterMenus.DateTime],
			[Enums.ServerType.TIME,			ColumnsManagers.FilterMenus.Time],
		]);
